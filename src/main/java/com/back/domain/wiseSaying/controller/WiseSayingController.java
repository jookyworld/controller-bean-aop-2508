...
public class WiseSayingController {
    ...
    public String write(@RequestParam(defaultValue = "내용") String content,
        ...
        WiseSaying wiseSaying = wiserSayingService.write(content, author);
    ...
    public String delete(@PathVariable int id) {
        WiseSaying wiseSaying = wiserSayingService.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("%d번 명언은 존재하지 않습니다.".formatted(id)));
        wiserSayingService.delete(wiseSaying);
    ...
    public String modify(
        ...
        WiseSaying wiseSaying = wiserSayingService.findById(id).orElseThrow(() -> new IllegalArgumentException("%d번 명언은 존재하지 않습니다.".formatted(id)));

        wiserSayingService.modify(wiseSaying, content, author);
